          ...
          {features.map((feature, index) => (
            <div key={index} className="p-4 md:w-1/3">
              <div
                ...
                className="flex rounded-xl h-full bg-[var(--bg-secondary)] border border-[var(--border)] p-8 flex-col transition-all duration-300 hover:shadow-lg focus:outline-none focus:ring-4 focus:ring-[var(--focus-ring)]"
              >
                {/* Title */}
                <h2
                ...
                {/* Description */}
                <p className="leading-relaxed text-[var(--text-secondary)] flex-grow">
                  {feature.description}
                </p>
              </div>
            </div>
