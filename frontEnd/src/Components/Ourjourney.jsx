...
export default function JourneyAndTesting() {
  return (
    <section
      className="py-24 px-6 lg:px-16 bg-[var(--bg-primary)] text-[var(--text-secondary)] relative transition-colors duration-300 border-b border-[var(--border-color)] shadow-sm"
      aria-labelledby="journey-heading"
    >

      {/* Soft Accent Glow */}
      <div className="absolute inset-0 bg-[var(--accent)] opacity-5 blur-[120px] -z-10" aria-hidden="true"></div>
      ...
      <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-16 items-start">
        ...
        <div
          className="bg-[var(--bg-secondary)] border border-[var(--border)] rounded-2xl p-8 shadow-[var(--card-shadow)]"
          role="region"
          aria-labelledby="testing-heading"
        >
          <div className="flex items-center gap-4 mb-6">
            <div className="w-12 h-12 flex items-center justify-center rounded-full bg-[var(--primary)]/10 text-[var(--primary)]">
          ...
          {/* Trust Points */}
          <ul className="mt-6 space-y-3 text-sm text-[var(--text-secondary)]" role="list">
            <li className="flex items-center gap-2">
              <Headphones className="w-4 h-4 text-[var(--primary)]" aria-hidden="true" />
              <span>Real screen reader testing</span>
            </li>
            <li className="flex items-center gap-2">
              <ShieldCheck className="w-4 h-4 text-[var(--primary)]" aria-hidden="true" />
              <span>WCAG 2.1 compliant structure</span>
            </li>
          </ul>
